WebAuthn Library
=============
[![GoDoc](https://godoc.org/github.com/pritunl/webauthn?status.svg)](https://godoc.org/github.com/pritunl/webauthn)
![Build Status](https://github.com/pritunl/webauthn/workflows/Go/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/github.com/pritunl/webauthn)](https://goreportcard.com/report/github.com/pritunl/webauthn)
...
### Demo at webauthn.io
An implementation of this library can be used at [webauthn.io](https://webauthn.io) and the code for this website can be found in the Duo Labs repository [`webauthn-io`](https://github.com/pritunl/webauthn.io).
...
Quickstart
----------
`go get github.com/pritunl/webauthn` and initialize it in your application with basic configuration values.
...
```golang
import "github.com/pritunl/webauthn/webauthn"
...
import "github.com/pritunl/webauthn/protocol"
import "github.com/pritunl/webauthn/webauthn"
